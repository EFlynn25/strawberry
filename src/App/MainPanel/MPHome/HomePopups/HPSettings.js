  ...
  render() {
    return (
      <div className="HPSettings">
        ...
        <div className="hpsContent"><HPSWrapper tab={this.state.tab} name="General" /></div>
        <div className="hpsContent"><HPSWrapper tab={this.state.tab} name="Messages" /></div>
        <div className="hpsContent"><HPSWrapper tab={this.state.tab} name="About" /></div>
